    ...
    for ntarget in range(2, ntargetmax):
        ...
        for i in range(ntrials):
            ...
            for step in range(1, nstep + 1):
                ...
                testtset[testind] = min(max(0, testtset[testind] - step),
                        nbins - 1)
                #print testtset
...
if __name__ == '__main__':
    ...
    ##########################################
    # Extract partition data at single level
    #cname = 'chr17'
    #beta = 7.0
    #ntarget = 19
    #membership, lims, ids = TOpt.get_partitions(cname, beta, ntarget)
    #print map(list, lims), ids
    ##########################################
    # Plot matrices
    f = []
    x = []
